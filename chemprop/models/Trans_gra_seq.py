...
class GraphFormer(nn.Module):
    ...
    def forward(self, seq_output,graph_output,mask):#,perturb=None):
        # graph_attn_bias
...
class Transformer(nn.Module):
    ...
    def forward(self, seq_output,graph_output,mask) -> torch.FloatTensor:
        output = self.encoder.forward(seq_output,graph_output,mask)
