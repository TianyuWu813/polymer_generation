...
from .Trans_feature import Transformer_fuse
...
class MoleculeModel(nn.Module):
    ...
    def forward(self, *input):
        ...
        trans_output = self.trans(seq_output,graph_bond_output,mask)

        molecule_emb = F.normalize(trans_output) + F.normalize(graph_output)
    ...
    def predict(self, *input):
        ...
        molecule_emb = F.normalize(seq_output) #F.normalize(trans_output)+ F.normalize(graph_output)
